/**
 * This file has been automatically generated at 2026-06-01T19:13:55.459Z
 *
 * Name:    Jutge API
 * Version: 2.0.0
 *
...
export type SubmitMathPlayer = {
    name: string
    user_uid: string
    submission_id: string
}

export type SubmitMathPlayers = SubmitMathPlayer[]

export type SubmitMatchIn = {
    problem_id: string
    compiler_id: string
    annotation: string
    players: SubmitMathPlayers
}
...
export class JutgeApiClient {
    ...
    JUTGE_API_URL =
        (typeof import.meta !== "undefined" && import.meta.env?.VITE_JUTGE_API_URL) ||
        "https://api.jutge.org/api"

    /** Headers to include in the API requests */
    headers: Record<string, string> = {
        ...(typeof import.meta !== "undefined" && import.meta.env?.VITE_JUTGE_DOMAIN
            ? { "x-forwarded-host": import.meta.env.VITE_JUTGE_DOMAIN }
            : {}),
    }
...
class Module_games {
    ...
    /**
     * Submit a match to a game problem.
     *
     * 🔐 Authentication: competitions
     * No warnings
     *
     */
    async submitMatch(data: SubmitMatchIn): Promise<string> {
